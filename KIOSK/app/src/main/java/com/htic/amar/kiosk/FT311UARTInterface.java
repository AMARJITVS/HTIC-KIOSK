...
public class FT311UARTInterface extends Activity
{
	...
	public byte ReadData(int numBytes,byte[] buffer, int [] actualNumBytes)
	{
		...
		if((numBytes < 1) || (totalBytes == 0)){
            Log.d("should be"," at least one byte to read>>>>>>>>");
			actualNumBytes[0] = 0;
			status = 0x01;
			return status;
		}
	...
	{
        Log.d("RESUME ACCESSORY",">>>>>>>>");

        // Intent intent = getIntent();
		if (inputstream != null && outputstream != null) {
            Log.d("RESUME ACCESSORY","IN $ OP IS NULL>>>>>>>>");
			return 1;
		}
		...
		if(accessories != null)
		{
            Log.d("RESUME ACCESSORY-","ACCESSORY ATTACHED>>>>>>>>");
			Toast.makeText(global_context, "Accessory Attached", Toast.LENGTH_SHORT).show();
		}
		else
		{
            Log.d("RESUME ACCESSORY-","ACCESSORY DETACHED>>>>>>>>");
	...
	public void DestroyAccessory(boolean bConfiged){
        ...
        Log.d("DESTROY ACCESSORY",">>>>>>>>");

        if(true == bConfiged){
            Log.d("DESTROY ACCESSORY","_SEND PACKET>>>>>>>>");
		...
		{
            Log.d("DESTROY ACCESSORY","_SET CONFIG>>>>>>>>");
	...
	{
        Log.d("OPEN ACCESSORY",">>>>>>>>");

        filedescriptor = usbmanager.openAccessory(accessory);
		if(filedescriptor != null){
            Log.d("OPEN ACCESSORY","_FILE DESCRIPTOR IS NULL>>>>>>>>");
			...
			if(inputstream == null || outputstream==null){
                Log.d("OPEN ACCESSORY","IP & OP IS NULL>>>>>>>>");
				return;
			}
	...
	{
        Log.d("CLOSE ACCESSORY",">>>>>>>>");

        try{
			if(filedescriptor != null)
                Log.d("CLOSE ACCESSORY","FILE DESCRIPTOR CLOSE>>>>>>>>");
		...
		try {
			if(inputstream != null)
                Log.d("CLOSE ACCESSORY","-INPUTSTREAM CLOSE>>>>>>>>");
				inputstream.close();
		} catch(IOException e){}

		try {
			if(outputstream != null)
                Log.d("CLOSE ACCESSORY","-OUTPUTSTREAM CLOSE>>>>>>>>");
				outputstream.close();
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			if (ACTION_USB_PERMISSION.equals(action)) 
			{
				synchronized (this)
				{
                    ...
                    Log.d("BROADCAST RECEIVER"," ACCESSORY>>>>>>>>"+accessory);
					if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false))
					{
                        Log.d("BROADCAST RECEIVER"," ALLOW>>>>>>>>");
						Toast.makeText(global_context, "USB Permission granted", Toast.LENGTH_SHORT).show();
						OpenAccessory(accessory);
					} 
					else 
					{
                        Log.d("BROADCAST RECEIVER"," DENY>>>>>>>>");
			...
			{
                Log.d("BROADCAST RECEIVER"," USB DETACHED>>>>>>>>");
